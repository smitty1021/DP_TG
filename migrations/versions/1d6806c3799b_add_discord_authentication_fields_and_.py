"""Add Discord authentication fields and role permissions

Revision ID: 1d6806c3799b
Revises: 
Create Date: 2025-07-22 18:15:34.250533
...
def upgrade():
    ...
    op.create_table('discord_role_permissions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('discord_role_id', sa.String(length=255), nullable=False),
    sa.Column('discord_role_name', sa.String(length=255), nullable=False),
    sa.Column('access_level', sa.Enum('basic', 'premium', 'vip', 'admin', name='access_levels'), nullable=False),
    sa.Column('can_access_portfolio', sa.Boolean(), nullable=False),
    sa.Column('can_access_backtesting', sa.Boolean(), nullable=False),
    sa.Column('can_access_live_trading', sa.Boolean(), nullable=False),
    sa.Column('can_access_analytics', sa.Boolean(), nullable=False),
    sa.Column('can_access_advanced_features', sa.Boolean(), nullable=False),
    sa.Column('custom_permissions', sa.JSON(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('discord_role_permissions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_discord_role_permissions_discord_role_id'), ['discord_role_id'], unique=True)
    ...
    sa.Column('discord_linked', sa.Boolean(), nullable=False),
    sa.Column('discord_roles', sa.JSON(), nullable=True),
    sa.Column('last_discord_sync', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    with op.batch_alter_table('global_image', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_global_image_entity_id'), ['entity_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_global_image_entity_type'), ['entity_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_global_image_upload_date'), ['upload_date'], unique=False)
        batch_op.create_index(batch_op.f('ix_global_image_user_id'), ['user_id'], unique=False)
...
def downgrade():
    ...
    op.drop_table('group')
    with op.batch_alter_table('global_image', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_global_image_user_id'))
        batch_op.drop_index(batch_op.f('ix_global_image_upload_date'))
        batch_op.drop_index(batch_op.f('ix_global_image_entity_type'))
        batch_op.drop_index(batch_op.f('ix_global_image_entity_id'))
        batch_op.drop_index('idx_global_image_user_date')
        batch_op.drop_index('idx_global_image_entity')

    op.drop_table('global_image')
    with op.batch_alter_table('file', schema=None) as batch_op:
    ...
    with op.batch_alter_table('discord_role_permissions', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_discord_role_permissions_discord_role_id'))

    op.drop_table('discord_role_permissions')
